<%-- 
    ...
    Created on : 2 Feb, 2018, 10:42:55 AM
    Author     : INSPIRON
--%>
...
<!-- jQuery -->
<!-- lined-icons -->
<link rel="stylesheet" href="../AdminAssets/css/icon-font.min.css" type='text/css' />
<!-- //lined-icons -->
<!-- chart -->
<script src="../AdminAssets/js/Chart.js"></script>
<!-- //chart -->
<!--animate-->
<link href="../AdminAssets/css/animate.css" rel="stylesheet" type="text/css" media="all">
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list">
							<a href="AdminHome"><i class="lnr lnr-cog"></i>
								<span>Teachers</span></a>
								<ul class="sub-menu-list">
									<li><a href="ViewTeacher.jsp">View teachers</a> </li>
									<li><a href="AddTeacher.jsp">Add teachers</a></li>
								</ul>
						</li>
						<li><a href="ViewStudent.jsp"><i class="lnr lnr-spell-check"></i> <span>Student</span></a></li>
                                                <li class="menu-list">
							<a href="AdminHome.jsp"><i class="lnr lnr-cog"></i>
								<span>Subject</span></a>
								<ul class="sub-menu-list">
							...
							<a href="AdminHome"><i class="lnr lnr-cog"></i>
								<span>Work</span></a>
								<ul class="sub-menu-list">
									<li><a href="ViewWork.jsp">View work</a> </li>
									<li><a href="AddWork.jsp">Add work</a></li>
								</ul>
						...
						<ul class="nofitications-dropdown">
							...
							<li class="login_box" id="loginContainer">
									<div class="search-box">
										...
										<script src="../AdminAssets/js/uisearch.js"></script>
											<script>
